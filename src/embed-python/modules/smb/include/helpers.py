...
#########################
#### Pretty Filename from file uploads ####
#########################
def pretty_filename(packet_request_layer):
	if 'Filename' in packet_request_layer.fields:
		f,v = packet_request_layer.getfield_and_val('Filename')
	elif 'FileName' in packet_request_layer.fields:
		f,v = packet_request_layer.getfield_and_val('FileName')
	else:
		return 'unnamed_file'

	filename = f.i2repr(packet_request_layer,v)
